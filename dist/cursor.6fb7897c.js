...
var cursorComponent = marker.components.cursor;
...
cursorComponent.onMouseMove = function () {
  ...
  return function (evt) {
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    direction.set(mouse.x, mouse.y, 0.5).applyMatrix4(matrix.getInverse(camera.projectionMatrix)).applyMatrix4(camera.matrixWorld).sub(origin).normalize();
...
cursorComponent.onMouseMove = bind(cursorComponent.onMouseMove, cursorComponent);
/* * * * * * * * * * * * * * * * * * * * * *
